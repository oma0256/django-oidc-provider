...
def migrate_response_type(apps, schema_editor):
    ...
    ResponseType = apps.get_model('oidc_provider_v2', 'ResponseType')
    Client = apps.get_model('oidc_provider_v2', 'Client')
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('oidc_provider_v2', '0025_user_field_codetoken'),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='client',
            name='response_types',
            field=models.ManyToManyField(to='oidc_provider_v2.ResponseType'),
        ),
