...
from oidc_provider_v2.lib.claims import ScopeClaims, StandardScopeClaims, STANDARD_CLAIMS
from oidc_provider_v2.tests.app.utils import create_fake_user, create_fake_client, create_fake_token
