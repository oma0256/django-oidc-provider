...
from oidc_provider_v2.tests.app.utils import (
    ...
    create_fake_token,
    FAKE_RANDOM_STRING)
from oidc_provider_v2.lib.utils.token import create_id_token
from oidc_provider_v2.views import TokenIntrospectionView
...
class IntrospectionTestCase(TestCase):
    ...
    def _make_request(self, **kwargs):
        url = reverse('oidc_provider_v2:token-introspection')
        data = {
    ...
    @override_settings(OIDC_INTROSPECTION_PROCESSING_HOOK='oidc_provider_v2.tests.app.utils.fake_introspection_processing_hook')  # NOQA
